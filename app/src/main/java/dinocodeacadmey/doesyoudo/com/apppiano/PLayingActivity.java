...
import static dinocodeacadmey.doesyoudo.com.apppiano.MainActivity.mFileName1;
import static dinocodeacadmey.doesyoudo.com.apppiano.MainActivity.mFileName2;
import static dinocodeacadmey.doesyoudo.com.apppiano.MainActivity.mFileName3;
import static dinocodeacadmey.doesyoudo.com.apppiano.MainActivity.mFileName4;
import static dinocodeacadmey.doesyoudo.com.apppiano.MainActivity.mFileName5;
import static dinocodeacadmey.doesyoudo.com.apppiano.MainActivity.mFileName6;
    ...
    private void startplaying(int recordingno) {
        ...
        try{
            ...
            switch (recordingno){
                ...
                case 1:
                    mPlayer.setDataSource(Companion.getMFileName1());
                    break;
                case 2:
                    mPlayer.setDataSource(Companion.getMFileName2());
                    break;

                case 3:
                    mPlayer.setDataSource(Companion.getMFileName3());
                    break;

                case 4:
                    mPlayer.setDataSource(Companion.getMFileName4());
                    break;

                case 5:
                    mPlayer.setDataSource(Companion.getMFileName5());
                    break;
                case 6:
                    mPlayer.setDataSource(Companion.getMFileName6());
                    break;
            }
